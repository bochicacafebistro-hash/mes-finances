...
const TRANSLATIONS = {
  ...
  re_field_services:     { fr: "Services / utilités ($/mois)",  es: "Servicios ($/mes)" },
  re_field_services_hint:{ fr: "Eau, gaz, déneigement, etc. (partie payée par le propriétaire)", es: "Agua, gas, etc. (parte pagada por el propietario)" },
