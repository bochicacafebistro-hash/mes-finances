...
const TRANSLATIONS = {
  ...
  re_field_maintenance_hint:{ fr: "% des loyers à provisionner. Neuf : 5%, ancien (avant 1980) : 8-10%. Minimum 0,5% de la valeur même si peu de loyers.", es: "% de los alquileres a reservar. Nuevo: 5%, antiguo (antes 1980): 8-10%." },
  re_field_vacancy:      { fr: "Taux d'inoccupation (%)",       es: "Tasa de desocupación (%)" },
  re_field_vacancy_hint: { fr: "Mtl/Qc urbain 2024-25 : 1,5-2% (SCHL). 3% est une marge prudente. 5%+ en région.", es: "Mtl/Qc 2024-25: 1,5-2% (CMHC). 3% prudente." },
  ...
  re_metric_dscr:        { fr: "DSCR",                          es: "DSCR" },
  re_metric_dscr_hint:   { fr: "Ratio de couverture du service de la dette : NOI / hypothèque annuelle. ≥ 1.20 = solide.", es: "Ratio de cobertura del servicio de deuda. ≥ 1.20 = sólido." },
  re_metric_coc:         { fr: "Cash-on-Cash",                  es: "Cash-on-Cash" },
  re_metric_coc_hint:    { fr: "Rendement annuel sur ta mise de fond : cash flow annuel / mise de fond. 4-8% = normal, 8%+ = excellent.", es: "Rendimiento anual sobre el aporte inicial. 4-8% normal, 8%+ excelente." },
  re_metric_breakeven:   { fr: "Seuil d'équilibre",             es: "Punto de equilibrio" },
  re_metric_breakeven_sub:{ fr: "Taux d'occupation minimal pour couvrir tous les frais", es: "Tasa mínima de ocupación para cubrir todos los gastos" },
  re_metric_breakeven_hint:{ fr: "Pourcentage des loyers à percevoir pour couvrir charges + hypothèque. Sous 85% = confortable, au-dessus de 95% = fragile.", es: "Porcentaje de alquileres a recibir para cubrir gastos + hipoteca." },
  ...
  re_metric_cash_to_close:{ fr: "Cash requis à l'achat",        es: "Efectivo requerido al cierre" },
  re_tip_cash_to_close:  { fr: "Total à sortir de ta poche pour fermer l'achat : mise de fond + tous les frais de clôture (taxe de bienvenue, notaire, inspection, autres). La prime SCHL n'est PAS incluse — elle est ajoutée au prêt et payée via l'hypothèque.", es: "Efectivo total a desembolsar al comprar: aporte inicial + costos de cierre." },
  ...
  re_suggested_why_good: { fr: "Limité par : {constraint}. À ce prix, le cash flow est positif, le cap rate est ≥ 4% et le MRB est ≤ 14 (seuils acceptables pour le Québec urbain).", es: "Limitado por: {constraint}. Cash flow positivo, cap rate ≥ 4%, MRB ≤ 14." },
  ...
  re_tip_cashflow:       { fr: "Argent qu'il te reste chaque mois APRÈS avoir tout payé : taxes, assurances, services, entretien, ET l'hypothèque. Positif = l'immeuble te paie. Négatif = tu mets de l'argent dedans chaque mois.", es: "Dinero que te queda cada mes después de pagar todo, incluyendo la hipoteca." },
  re_tip_cap_rate:       { fr: "Taux de capitalisation (cap rate) = rendement de l'immeuble si tu l'achetais comptant (sans hypothèque). Pour 100$ payés, l'immeuble génère X$ de revenu net par année. 4-6% = normal au Québec. 6%+ = excellent. Sous 4% = cher.", es: "Cap rate = rendimiento si compraras al contado. 4-6% normal, 6%+ excelente." },
  re_tip_mrb:            { fr: "Multiplicateur du revenu brut (MRB) = combien de fois les revenus locatifs annuels tu paies pour l'immeuble. Si MRB=10, tu paies 10 années de loyers bruts. Plus c'est bas, mieux c'est. Sous 8 = aubaine, 8-14 = normal au Québec, 14+ = cher.", es: "Multiplicador del ingreso bruto. Bajo es mejor: <8 ganga, 8-14 normal en Quebec, 14+ caro." },
  re_tip_dscr:           { fr: "DSCR (Debt Service Coverage Ratio) = est-ce que l'immeuble paie sa propre hypothèque? Si DSCR=1.0, c'est juste équilibré. ≥1.20 = solide (les banques exigent souvent ça). <1.0 = tu dois mettre de l'argent pour couvrir l'hypothèque.", es: "DSCR = capacidad del inmueble para pagar su propia hipoteca. ≥1.20 sólido, <1.0 insuficiente." },
  re_tip_coc:            { fr: "Cash-on-Cash = rendement annuel sur ta mise de fond. Si tu mets 100 000$ de mise et l'immeuble te génère 5 000$ de cash flow par année, ton Cash-on-Cash = 5%. 4-8% = normal, 8%+ = excellent.", es: "Rendimiento anual sobre tu aporte inicial. 4-8% normal, 8%+ excelente." },
  re_tip_breakeven:      { fr: "Seuil d'équilibre = à quel taux d'occupation tu commences à perdre de l'argent. Si c'est 85%, ça veut dire que tu peux avoir 15% de tes loyers vides avant d'être dans le rouge. Plus bas = plus sécuritaire.", es: "Punto de equilibrio: nivel mínimo de ocupación para no perder dinero." },
  re_tip_mortgage_pmt:   { fr: "Paiement hypothécaire = montant que tu payes au prêteur. Les versions accélérées (bi-mensuel ou hebdo) te font payer ~1 versement de plus par année, donc remboursent l'hypothèque plus vite.", es: "Pago hipotecario. Pagos acelerados reducen el tiempo total de amortización." },
  re_tip_total_exp:      { fr: "Toutes les dépenses d'opération sur 1 an (taxes municipales + taxes scolaires + assurances + services + entretien + gestion). N'inclut PAS le paiement d'hypothèque.", es: "Todos los gastos operativos anuales (sin hipoteca)." },
  re_tip_stress:         { fr: "Stress test = simulation : qu'arrive-t-il si ton taux hypothécaire monte de 2% au renouvellement? Te montre ton cash flow dans ce scénario. Si tu restes positif = tu es solide. Sinon = risque réel quand les taux remontent.", es: "Simula qué pasa si tu tasa hipotecaria sube 2%. Mide tu resistencia financiera." },
  re_tip_cost_to_live:   { fr: "Coût réel pour t'habiter dans ton logement après que les autres locataires payent leur part. Si positif, ça sort de ta poche chaque mois. Si négatif (rare!), tu encaisses même en habitant.", es: "Costo real para habitar tu vivienda tras los alquileres de los demás." },
  re_tip_appreciation:   { fr: "Hausse annuelle moyenne de la valeur de l'immeuble. Long terme au Québec : 4-5% par an (nominal). C'est ce qui crée la 'prise de valeur' projetée.", es: "Aumento anual promedio del valor del inmueble." },
  re_tip_rent_increase:  { fr: "Augmentation annuelle des loyers. Au Québec, encadré par le TAL : 3,1% pour 2026 (basé sur la moyenne IPC sur 3 ans). Historique : 1-3%/an.", es: "Aumento anual de alquileres. Quebec 2026: 3,1% (TAL)." },
  re_tip_vacancy:        { fr: "% des loyers qu'on présume perdu chaque année à cause de logements vides entre deux locations. Mtl/Québec urbain : ~1,5-2%. 3% est une marge prudente.", es: "% de alquileres perdidos por vacancia anual." },
  re_tip_maintenance:    { fr: "% des loyers à mettre de côté chaque année pour l'entretien et les rénovations. Neuf : 5%. Bâti avant 1980 : 8-10%. Couvre toit, fournaise, plomberie, peinture, etc.", es: "% de alquileres a reservar para mantenimiento anual." },
  re_tip_management:     { fr: "% des loyers à payer si tu engages un gestionnaire externe. 0% si tu gères toi-même. 5-8% pour un gestionnaire pro (Mtl/Qc).", es: "% para gestor externo. 0% si autogestionas." },
  re_tip_dp_mode:        { fr: "Tu peux entrer ta mise de fond soit en montant ($), soit en pourcentage (%) du prix d'achat. Les deux sont équivalents — choisis selon ce qui est plus facile pour toi.", es: "Aporte inicial en $ o en %. Equivalentes." },
  re_tip_payment_freq:   { fr: "Mensuel = 12 paiements/an. Bi-mensuel accéléré = 26 paiements/an (~13 paiements mensuels). Hebdo accéléré = 52 paiements/an. Les versions accélérées te font payer ~1 mois de plus par année, ce qui réduit l'amortissement total.", es: "Frecuencias aceleradas reducen el plazo total." },
  re_tip_amort:          { fr: "Nombre d'années pour rembourser entièrement l'hypothèque. Standard au Canada : 25 ans (hypothèque assurée) ou 30 ans (non-assurée).", es: "Plazo de amortización. Estándar Canadá: 25 años." },
  re_tip_interest:       { fr: "Taux d'intérêt annuel sur l'hypothèque. Au Canada, calculé en composition semi-annuelle (la norme légale).", es: "Tasa anual de la hipoteca. Composición semestral en Canadá." },
  re_tip_owner_occupied: { fr: "Coche si TU habites dans ce logement (ce n'est pas une unité louée). Aucun loyer ne sera compté pour cette unité, mais l'app te montre combien ça te coûte par mois d'habiter là.", es: "Marca si TÚ habitas esta vivienda." },
  re_tip_utilities:      { fr: "Coche si le loyer inclut le chauffage et l'électricité (donc payés par toi le propriétaire). Décocher = le locataire paie sa propre électricité.", es: "Marca si el alquiler incluye calefacción y electricidad." },

  // ── Projection long terme ─────────────────────────
  re_section_closing:    { fr: "Frais de clôture & assurance SCHL", es: "Costos de cierre y seguro SCHL" },
  re_field_auto_calc:    { fr: "Calcul automatique",           es: "Cálculo automático" },
  re_field_welcome_tax:  { fr: "Taxe de bienvenue (mutation)", es: "Impuesto de bienvenida" },
  re_tip_welcome_tax:    { fr: "Droits de mutation immobilière au Québec, payés une seule fois à l'achat. Calcul par tranches : 0,5% sur la 1ère tranche (jusqu'à ~58k$), 1% jusqu'à ~295k$, 1,5% jusqu'à ~552k$, 2% au-dessus. Montréal a des tranches supplémentaires plus élevées.", es: "Impuesto único de transferencia inmobiliaria pagado al comprar." },
  re_field_notary:       { fr: "Honoraires notaire",           es: "Honorarios notario" },
  re_tip_notary:         { fr: "Frais payés au notaire pour la transaction (acte d'achat, hypothèque, vérifications). Habituellement 1 200 $ à 2 500 $ selon la complexité.", es: "Honorarios del notario para la transacción. Típicamente 1200-2500$." },
  re_field_inspection:   { fr: "Inspection pré-achat",         es: "Inspección previa" },
  re_tip_inspection:     { fr: "Inspection professionnelle de l'immeuble avant l'achat. Fortement recommandée. Coût 400-800 $ pour résidentiel, plus pour multiplex.", es: "Inspección profesional antes de comprar. 400-800$." },
  re_field_other_closing:{ fr: "Autres frais de clôture",      es: "Otros gastos de cierre" },
  re_field_other_closing_hint:{ fr: "Assurance titre, évaluation, ajustements de taxes, etc. Optionnel.", es: "Seguro de título, evaluación, ajustes. Opcional." },
  re_field_closing_total:{ fr: "Total des frais de clôture :", es: "Total gastos de cierre:" },
  re_field_schl:         { fr: "Prime SCHL (assurance hypothécaire)", es: "Prima CMHC (seguro hipotecario)" },
  re_tip_schl:           { fr: "Au Canada, si tu mets moins de 20% en mise de fond, tu DOIS souscrire une assurance hypothécaire (SCHL/CMHC, Genworth ou Canada Guaranty). La prime est ajoutée au principal du prêt et tu paies l'intérêt dessus. Taux : 4% du prêt si MF 5-10%, 3,1% si MF 10-15%, 2,8% si MF 15-20%.", es: "Si pones menos de 20% inicial, debes pagar seguro hipotecario. Se añade al principal del préstamo." },
  re_field_schl_hint:    { fr: "La prime s'ajoute au montant emprunté (donc à l'hypothèque mensuelle), elle n'est pas payée comptant.", es: "La prima se añade al préstamo, no se paga en efectivo." },
  re_field_schl_not_needed:{ fr: "Pas d'assurance SCHL requise (mise de fond ≥ 20%)", es: "Sin seguro CMHC requerido (≥20% inicial)" },
  ...
  re_field_rent_increase_hint:{ fr: "Augmentation annuelle. TAL Qc 2026 : 3,1% (méthode CPI 3 ans). Historique 1-3%/an.", es: "Aumento anual. TAL Qc 2026: 3,1%. Histórico 1-3%/año." },
  re_field_mrb_good:     { fr: "Seuil MRB \"bon\" pour ce secteur", es: "Umbral MRB \"bueno\" para este sector" },
  re_field_mrb_good_hint:{ fr: "Centre Mtl : 15-18 normal. Plateau Qc : 12-14. Banlieue/régions : 8-12.", es: "Centro Mtl: 15-18. Plateau Qc: 12-14. Suburbios: 8-12." },
  re_tip_mrb_good:       { fr: "Multiplicateur du revenu brut maximum pour considérer un achat comme un BON investissement dans ce secteur. Si le MRB de l'immeuble est sous ce seuil, le prix par rapport aux loyers est acceptable pour la région.", es: "MRB máximo para considerar la compra como buena inversión en este sector." },
  re_field_mrb_excellent:{ fr: "Seuil MRB \"excellent\" pour ce secteur", es: "Umbral MRB \"excelente\" para este sector" },
  re_field_mrb_excellent_hint:{ fr: "Centre Mtl : 11-13. Plateau Qc : 9-10. Banlieue : 6-8.", es: "Centro Mtl: 11-13. Plateau Qc: 9-10. Suburbios: 6-8." },
  re_tip_mrb_excellent:  { fr: "Multiplicateur du revenu brut maximum pour qualifier un achat d'EXCELLENT investissement. Doit être inférieur au seuil \"bon\". Les marchés tendus tolèrent un MRB plus élevé.", es: "MRB máximo para excelente. Debe ser menor que el seuil 'bueno'." },
  ...
  re_chart_title:        { fr: "Évolution sur la durée projetée", es: "Evolución durante el plazo proyectado" },
  re_chart_value:        { fr: "Valeur de l'immeuble",         es: "Valor del inmueble" },
  re_chart_balance:      { fr: "Solde hypothécaire restant",   es: "Saldo hipotecario restante" },
  re_chart_equity:       { fr: "Équité accumulée",             es: "Capital acumulado" },
  re_chart_year:         { fr: "Année",                        es: "Año" },
};
