...
const TRANSLATIONS = {
  ...
  re_tip_mrb:            { fr: "Multiplicateur du revenu brut (MRB) = combien de fois les revenus locatifs annuels tu paies pour l'immeuble. Si MRB=10, tu paies 10 années de loyers bruts. Plus c'est bas, mieux c'est. Sous 8 = aubaine, 8-12 = normal, 12+ = cher.", es: "Multiplicador del ingreso bruto. Bajo es mejor: <8 ganga, 8-12 normal, 12+ caro." },
